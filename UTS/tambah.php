...
<body bgcolor="#CCCCCC">
<h2><p align="center">TAMBAH DATA MAHASISWA</p></h2>
...
<table width="546" border="0" cellpadding="0" cellspacing="0" align="center" bgcolor="#FFFFFF">
  ...
  <tr>
    <td height="27" align="right" valign="middle">Prodi</td>
    <td align="center" valign="top">:</td>
    <td valign="middle"><label>
      <select name="kelas">
  ...
  <tr>
    <td height="42"> </td>
    <td> </td>
    <td><input type="submit" name="ttambah" value="TAMBAH" title="Tambah"></td>
